...
const faqs = [
  { q: "¿Cómo cambio mi correo electrónico?", category: "Cuenta" },
  { q: "¿Cómo agrego un segundo empleado?", category: "Equipo" },
  { q: "¿Cuántos servicios puedo crear?", category: "Servicios" },
  { q: "¿Cómo configuro pagos en línea?", category: "Pagos" },
  { q: "¿Puedo usar Aionios en mi teléfono?", category: "General" },
];
        ...
        <div className="space-y-4">
          <div className="bg-indigo-600 rounded-2xl p-5 text-white">
            ...
            <p className="text-indigo-200 text-xs mb-4">
              Nuestro equipo está disponible de lunes a viernes de 9:00 a 18:00 hrs.
            </p>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-5">
            ...
            <div className="space-y-2">
              {faqs.map((faq, i) => (
                <button key={i} className="w-full flex items-start justify-between gap-2 p-3 rounded-xl hover:bg-slate-50 text-left transition-colors group cursor-pointer">
                  <div>
                    <p className="text-xs font-medium text-slate-700 group-hover:text-indigo-700 transition-colors">{faq.q}</p>
